        ...
        private void ShowDigitalTime(Graphics gr)
        {
            ...
            if (ShowDigital)
            {
                using (Font font = new Font("Times New Roman",
                    ClientSize.Height / 8, GraphicsUnit.Pixel))
                {
                    using (StringFormat string_format = new StringFormat())
                    {
                        ...
                        gr.DrawString(DateTime.Now.ToLongTimeString(),
                            font, Brushes.Black, 0, -font.Height+40,
                            string_format);
                        gr.DrawString(DateTime.Now.ToString("dd/MM/yy"),
                            new Font("Times New Roman",ClientSize.Height / 14, GraphicsUnit.Pixel), Brushes.Blue, 0, -font.Height + 60,
                            string_format);
                    }
                }
            }
